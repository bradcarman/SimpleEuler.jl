...
prob0 = ODEProblem(fmm0, [0.0], (0.0, 0.01), [F, k, d])
prob1 = ODEProblem(fmm1, [0.0, F/d], (0.0, 0.01), [F, k, d])
prob2 = ODEProblem(fmm2, [0.0, F/d, 0.0], (0.0, 0.01), [F, k, d])
prob3 = ODEProblem(fmm3, [0.0, F/d, 0.0, 0.0], (0.0, 0.01), [F, k, d])
...
ref3 = solve(prob3, ImplicitEuler(;autodiff); abstol, dt, adaptive=false, initializealg=NoInit()) #fails only with autodiff=true
